...
export default function Hero(): JSX.Element {
    ...
    return (
        ...
        >
            <div className="w-full max-w-[1280px] mx-auto mt-[82px] md:mt-[90px] mb-[40px]  px-6 md:px-[32px]">
                {/* Headings */}
                <h1 className="text-fluid-h1 font-semibold text-[#333333] mb-[24px] md:mb-[40px] tracking-heading ">
                ...
                <div className="max-w-[353px] md:max-w-[1280px] mx-auto">
                    ...
                    <p className="text-[#737373] text-fluid-small tracking-para">
                        Whether you're scaling, managing a growing team, or optimizing HR operations, <br className="hidden md:block" /> Accqrate People is built to simplify every aspect of HR from recruitment <br className="hidden md:block" /> to retirement on a single, secure platform.
                    </p>
                </div>
