    ...
    return (
        <>
            ...
            >
                ...
                <p className="text-center text-fluid-small md:text-fluid-body tracking-para leading-tight font-medium mt-6 lg:mt-[40px] max-w-[343px] mx-auto md:max-w-[1280px] ">
                    Empower Your Sales with Intelligent Lead  Management & Conversion
                </p>

                <p className="text-center text-fluid-small tracking-para font-normal leading-tight text-[#333333] mt-16px md:mt-6 max-w-[353px] mx-auto md:max-w-[1280px]">
            ...
            <section className={sectionClasses}>
                <div className={containerClasses}>
                    ...
                    >
                        <CustomImage
                            src="/images/business/crm/zatak.svg"
                            alt="E-Invoice"
                            width="350"
                            height="350"
