...
export default function InfoCard({ icon, title, description, color, link }: InfoCardProps) {
  return (
    <Link href={link} className="w-full">
      <div
        className="cursor-pointer flex items-center justify-between w-full h-auto lg:h-[96px] mx-auto overflow-hidden rounded-2xl shadow-[0_0_2px_rgba(0,0,0,0.25)] transition-all hover:shadow-md p-6 sm:p-5"
