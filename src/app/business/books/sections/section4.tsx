...
export default function AutomationSection(): JSX.Element {
  ...
  md:flex md:items-center">
              ...
              <Accordion type="single" collapsible className="w-full max-w-[400px]">
                {dropdowns.map((item, index) => (
                  <AccordionItem key={index} value={`rec-${index}`}>
                    ...
                    <AccordionContent className="text-fluid-small md:text-[16px]">
                      {item.content}
                    </AccordionContent>
                  </AccordionItem>
                ))}
        ...
        <div className="my-12 mx-auto font-inter md:max-w-5xl ">
          ...
          <FadeUp className="text-center mb-6 md:mb-4 md:flex md:justify-center">
            <h2 className="text-fluid-h2 font-semibold">
              ...
              <span className="font-semibold text-[#1976D2]"> Onboarding</span>
            </h2>
          </FadeUp>
              ...
              >
                ...
                >
                  ...
                  <div className="p-4 flex-1">
                    <h3 className="font-semibold text-[20px] md:text-[18px] lg:text-[20px] text-center">
                      On Demand Training
                    </h3>
                    <p className="text-[#737373] text-fluid-small lg:text-[16px] mt-2  text-center">
                      Learn Accqrate Books in under 60 minutes video modules for every type.
                    </p>
                    <p className="absolute bottom-2 left-4 text-[16px] text-[#1976D2] font-bold leading-tight inline-block">
              ...
              >
                ...
                >
                  ...
                  <div className="p-4 flex-1">
                    ...
                    <p className="absolute bottom-2 left-1 text-[#1976D2] text-[16px] text-left font-bold inline-block">
                      +971505515388
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                >
                  ...
                  <div className="p-4 flex-1 relative">
                    ...
                    <p className="absolute bottom-2 left-4 text-[#1976D2] text-[16px] font-bold leading-tight inline-block">
      ...
      <div className="my-12 md:my-[56px] lg:my-10 bg-[#F2F2F2] w-full py-6" >
        <div className="max-w-[1280px] mx-auto px-6 md:px-[32px] font-inter">
          <FadeUp className="text-fluid-h2 font-medium mb-6 md:mb-[32px] text-center leading-snug">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 lg:gap-12">
            ...
            {/* Text List */}
            <FadeUp>
              <ul className="text-left list-disc list-inside text-fluid-small lg:text-[16px] leading-6 space-y-4 md:space-y-6">
