                    ...
                    <FadeUp className="py-6 px-6 md:p-[32px] rounded-xl md:rounded-2xl mx-auto md:flex">
                        ...
                        <div className="flex-1 mt-6 lg:mt-0 flex justify-center items-center">
                            <video
                                ...
                                playsInline
                            >
                                <source src="/videos/business/books/account-receivables.mp4" type="video/mp4" />
                            </video>
                        </div>
                    </FadeUp>
                </div>
                    ...
                    <FadeUp className="py-6 px-6 md:p-[32px] rounded-xl md:rounded-2xl mx-auto md:flex">
                        ...
                        <div className="flex-1 mt-6 lg:mt-0 flex justify-center items-center">
                            <video
                                ...
                                playsInline
                            >
                                <source src="/videos/business/books/Accounts_payables.mp4" type="video/mp4" />
                            </video>
                        </div>
                    </FadeUp>
                            ...
                            <div className="rounded-xl md:rounded-2xl mx-auto md:flex md:bg-white md:p-[32px] md:shadow-[9px_7px_16.9px_rgba(67,160,71,0.2)]">
                                ...
                                <div className="flex-1 mt-6 lg:mt-0 flex justify-center items-center">
                                    <video
                                        ...
                                        playsInline
                                    >
                                        <source src="/videos/business/books/Smart_expense_management.mp4" type="video/mp4" />
                                    </video>
                                </div>
                            </div>
                        </section>
                        ...
                        <FadeUp className="py-6 px-6 md:p-[32px] rounded-xl md:rounded-2xl mx-auto md:flex">
                            ...
                            <div className="flex-1 mt-6 lg:mt-0 flex justify-center items-center">
                                <video
                                    ...
                                    playsInline
                                >
                                    <source src="/videos/business/books/Financial_statements.mp4" type="video/mp4" />
                                </video>
                            </div>
                        </FadeUp>
                    </div>
