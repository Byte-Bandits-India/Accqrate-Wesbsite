...
const Section1 = () => {
    ...
    return <section className='bg-gradient-to-t from-[#EFF3FF] to-transparent'>
                            ...
                            >
                                ...
                                <div className="flex justify-between items-end mb-4">
                                    <img
                                        src={feature.img}
                                        alt={feature.title}
                                        className="w-full maxh-[99px] h-auto object-contain"
                                    />
                                ...
                                <div className="mb-3 min-h-[60px] flex items-start">
                                    <div>
                                        <h2 className="text-lg font-medium text-[#000000] leading-tight mb-1">
                                            <T>{feature.title}</T>
                                        </h2>
                                        {feature.sub && (
                                            <h2 className="text-lg font-medium text-[#000000] leading-tight">
                                                <T>{feature.sub}</T>
                                            </h2>
                                        )}
                                    </div>
                                ...
                                <div className="flex-1 flex items-start">
                                    <p className="text-[#000000] text-sm leading-relaxed line-clamp-4">
