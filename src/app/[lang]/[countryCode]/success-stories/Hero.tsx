    ...
    <section className="bg-[#F8F6FF] py-20">
      <div className="container mx-auto px-6 md:px-16">
        ...
        <div className="text-left mb-10">
          <FadeUp className="text-fluid-h1 lg:text-[58px] font-bold text-gray-900 leading-tight">
          ...
          <FadeUp className="text-fluid-body font-semibold text-gray-900 mt-6 md:mt-8 ">
            Explore How We've Digitized And Empowered Businesses Across Various Industries
          </FadeUp>

          <FadeUp className="text-gray-700 text-fluid-small max-w-[1216px] mt-6 md:mt-8">
