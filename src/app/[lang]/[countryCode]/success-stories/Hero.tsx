      ...
      <div className="bg-gradient-to-b from-[#EFF3FF00] to-[#EFF3FF] py-20">
        <div className="max-w-[1280px] mx-auto px-6 md:px-16">
          ...
          <div className="text-center mb-10">
            ...
            <FadeUp className="text-fluid-h1 lg:text-[58px] font-medium text-gray-900 leading-tight">
              Digitalising Businesses Across <br className="hidden md:block" /> Industries
            </FadeUp>

            <div className="max-w-[1074px] mx-auto  ">
              <FadeUp className="text-fluid-body font-medium text-[#194BED] mt-6 md:mt-8 ">
