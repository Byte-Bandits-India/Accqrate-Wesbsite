...
function ZatcaComprehensive() {
  return (
    ...
    >
      ...
      <h3 className="text-[22px] md:text-[26px] font-semibold leading-snug mb-4">
        <T>
      ...
      <div className="text-[15px] md:text-[16px] text-gray-700 leading-relaxed mb-4 space-y-3">
        <p>
          <T>
      ...
      <div className="text-[15px] md:text-[16px] text-gray-700 leading-relaxed mb-5 space-y-3">
        <p>
          <T>
      ...
      <ul className="list-disc pl-6 mb-5 text-[15px] md:text-[16px] text-gray-700 leading-relaxed space-y-1">
      ...
      <div className="overflow-x-auto my-4">
        <table className="w-full border border-gray-300 text-[15px] md:text-[16px]">
          <tbody>
      ...
      <p className="text-center text-[15px] md:text-[16px] text-gray-700 mb-6">
      ...
      <div className="text-[15px] md:text-[16px] text-gray-700 leading-relaxed space-y-3">
