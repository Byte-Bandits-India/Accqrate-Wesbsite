...
function OracleInvoicing() {
  return (
    ...
    >
      <img
        src="/images/invoicing/oracle1.png"
      ...
      <p>
        <T>
          <a href="https://www.oracle.com/in/cx/service/">
            <T>Oracle Fusion</T>
          </a>
          <T>
          ...
          <a href="https://www.oracle.com/in/integration/">
          ...
          <a href="https://zatca.gov.sa/en/Pages/default.aspx">
            <T>ZATCA</T>
          </a>
      ...
      <p>
        <T>Accqrate’s E-invoicing package for Oracle Fusion operates in real-time for Tax invoices and in batch mode for Simplified invoices, establishing a bridge with ZATCA (Fatoora Portal).</T>
      </p>

      <img src="/images/invoicing/oracle14.png" className="w-100 mb-2" alt="integration1" />
      ...
      <img src="/images/invoicing/oracle10.png" className="w-100 mb-2" alt="oracle10" />
      ...
      <img src="/images/invoicing/oracle8.png" className="w-100 mb-2" alt="oracle8" />
      ...
      <img src="/images/invoicing/oracle6.png" className="w-100 mb-2" alt="oracle6" />
      ...
      <img src="/images/invoicing/oracle13.png" className="w-100 mb-2" alt="oracle13" />

      <p>
        <T>Search the order and select the “Fulfillment View”</T>
      </p>

      <img src="/images/invoicing/oracle11.png" className="w-100 mb-2" alt="oracle11" />
      <img src="/images/invoicing/oracle4.png" className="w-100 mb-2" alt="oracle4" />
      <img src="/images/invoicing/oracle7.png" className="w-100 mb-2" alt="oracle7" />
      ...
      <img src="/images/invoicing/oracle5.png" className="w-100 mb-2" alt="oracle5" />

      <p>
        <T>In a few milliseconds, the response (approval or rejection) is received from ZATCA.</T>
      </p>

      <img src="/images/invoicing/oracle1.png" className="w-100 mb-2" alt="oracle1" />
      ...
      <img src="/images/invoicing/oracle2.png" className="w-100 mb-2" alt="oracle2" />
      <p>
      ...
      <img src="/images/invoicing/oracle3.png" className="w-100 mb-2" alt="oracle3" />
      ...
      <img src="/images/invoicing/oracle12.png" className="w-100 mb-2" alt="oracle12" />
      <img src="/images/invoicing/oracle9.png" className="w-100 mb-2" alt="oracle9" />
      <img src="/images/invoicing/oracle15.png" className="w-100 mb-2" alt="oracle15" />
      ...
      <ul>
        <li>
          ...
          <T>
            Enjoy end-to-end encryption ensuring data safety and audit-compliant invoices.
          </T>
        </li>
        <li>
          <strong>
          ...
          <T>
            Get ZATCA integration live in under two weeks with minimal disruption.
          </T>
        </li>
        <li>
          <strong>
          ...
          <T>
            Experience Accqrate’s capabilities with a complimentary ZATCA Sandbox test.
          </T>
        </li>
        <li>
          <strong>
