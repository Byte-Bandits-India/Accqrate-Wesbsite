...
function SapEcc() {
  return (
    ...
    >
      ...
      <ul>
        <li>
          <T>Rising support and maintenance fees for SAP ECC extended support</T>
        </li>
        <li>
          <T>
        ...
        <li>
          <T>Expensive and complex third-party integrations</T>
        </li>
        <li>
          <T>Vendor lock-in and increased dependency</T>
        </li>
        <li>
          <T>Limited access to modern features and analytics</T>
        </li>
        <li>
          <T>Growing security and compliance risks as the technology becomes obsolete</T>
        </li>
      </ul>
      <hr />
      <h2>
      ...
      <b>1. Greenfield: Fresh Implementation</b>
      <ul>
        <li>
          <T>Re-implement your ERP system from scratch</T>
        </li>
        <li>
          <T>Opportunity to optimize processes and migrate to cloud (public or private)</T>
        </li>
        <li>
          <T>Suitable for organizations willing to completely redesign their ERP landscape</T>
        </li>
      </ul>
      <b>2. Brownfield: System Conversion</b>
      <ul>
        <li>
          <T>Upgrade your existing SAP ECC system to S/4HANA, preserving customizations and data</T>
        </li>
        <li>
          <T>Less disruptive, but limited improvements to business processes</T>
        </li>
      </ul>
      <b>3. Selective Data Transition (Hybrid)</b>
      <ul>
        <li>
          <T>Migrate select data and processes in an agile, phased approach</T>
        </li>
        <li>
          <T>Offers a balance between fresh implementation and system conversion</T>
        </li>
      </ul>
      <h4>
        <T>Key Risks:</T>
      ...
      <ul>
        <li>
          <T>High implementation and licensing costs</T>
        </li>
        <li>
          <T>Steep learning curve and resource training expenses</T>
        </li>
        <li>
          <T>Knowledge transfer challenges</T>
        </li>
        <li>
          <T>Potential for minimal process improvement (especially with Brownfield)</T>
        </li>
        <li>
          <T>Complex decisions around data migration and regulatory compliance</T>
        </li>
      </ul>
      <h2>
      ...
      <ul>
        <li>
          <T>The need to justify ERP migration to stakeholders</T>
        </li>
        <li>
          <T>Ensuring seamless data migration and regulatory compliance</T>
        </li>
        <li>
          <T>Requirement for a flexible, customizable ERP</T>
        </li>
        <li>
          <T>Desire for a modern user experience and faster innovation</T>
        </li>
      </ul>
      <hr />
      <h2>
      ...
      <ul>
        ...
        <li>
          <T>Business process automation leveraging modern technology stacks</T>
        </li>
        <li>
          <T>AI-powered analytics and automation for smarter decision-making</T>
        </li>
        <li>
          <T>Simple, intuitive user interface for fast adoption</T>
        </li>
        <li>
          <T>Flexible deployment: On-premises or cloud (private/public/hybrid)</T>
        </li>
        <li>
          <T>Rapid implementation: Go live in 1–3 months (vs. 12–24 months for SAP projects)</T>
        </li>
        <li>
          <T>No vendor lock-in: You own your data and can export anytime</T>
        </li>
        <li>
          <T>Dramatic cost savings: Up to 50x lower total cost of ownership compared to SAP</T>
        </li>
        <li>
          <T>Easily customizable: Tailor modules to your unique business needs</T>
        </li>
        <li>
          <T>Robust integration ecosystem: Connect with your legacy systems and modern apps</T>
        </li>
      </ul>
      <hr />
      <h2>
      ...
      <ul>
        <li>
          <T>Ensure uninterrupted operations beyond SAP ECC’s end of support</T>
        </li>
        <li>
          <T>Achieve global E-invoicing compliance with ease</T>
        </li>
        <li>
          <T>Unlock modern business process automation and analytics</T>
        </li>
        <li>
          <T>Save costs and accelerate your digital transformation</T>
        </li>
      </ul>
      <h2>
