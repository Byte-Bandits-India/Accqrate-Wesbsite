  ...
  return (
    <div
      className="absolute rounded-2xl shadow-xl flex
             ...
             transition-all duration-500 ease-in-out overflow-hidden bg-[#E6F2FF]"
      style={style}
      onClick={onClick}
    >
      ...
      {/* Text content area - Separate right section */}
      <div className="flex-1 flex flex-col justify-start p-6 md:pl-8 lg:px-[60px] relative z-20">
        {/* Quote text - stays on right side */}
        <p className="text-[#000000] text-fluid-small md:text-[18px] lg:text-[20px] leading-tight flex-1 drop-shadow-md font-bold text-left">
          &quot;{quote}&quot;
        </p>

        {/* Name only - positioned on right side */}
        <div className="flex justify-start mt-4">
          <div className="text-right">
            <h4 className="text-[#000000] font-medium text-[10px] md:text-[14px] text-left lg:text-[16px] drop-shadow-md">
              {name}
            </h4>
          </div>
        </div>
...
const Carousel: React.FC<CarouselProps> = ({
  ...
  return (
    <div
      className="relative w-full flex flex-col items-center justify-center overflow-hidden select-none px-4 py-8"
    ...
    >
      ...
      >
        {items.map((item, index) => {
          ...
          return <CarouselCard key={index} {...item} style={{ transform, opacity, filter: blur, zIndex }} />;
        })}
      </motion.div>

      <CarouselDots total={items.length} currentIndex={currentIndex} onDotClick={setCurrentIndex} />
    </div>
  );
};
  ...
  return (
    <main className="overflow-x-hidden font-inter">
      <div className="bg-[#E9E8FF]">
        <div className="min-h-dvh xl:min-h-fit bg-[url('/images/sunset.png')] bg-cover bg-no-repeat bg-center lg:bg-local">
        ...
        {/* /Why Accqrate? */}
        <div>
          <div className="max-w-[1440px] w-full mx-auto px-6 md:px-8 mt-[48px]">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="flex flex-col justify-start lg:justify-center">
                <p className="text-fluid-small font-normal mt-[20px] md:mt-[38px] lg:mt-0">
                ...
                <button
                  className="h-[40px] w-[144px] md:w-[199px] text-white text-fluid-small md:text-[18px] mt-[20px] md:mt-[30px]"
            ...
            <div className="mt-[73px] grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-10">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center md:items-start text-center max-w-[242px] mx-auto md:max-w-[207px]"
                >
                  <img className="mb-4" src={feature.img} alt={feature.title} />
                  <h2 className="text-fluid-h3 xl:text-[23px] font-medium mb-2 md:text-left">{feature.title}</h2>
        ...
        <div className="mt-[80px] rounded-[30px] bg-[linear-gradient(180deg,#FFFFFF_0%,#E9E8FF_50%,#4F52FF_100%)] py-6 md:py-8 max-w-[1440px] mx-auto">
          ...
          <FadeUp className="mb-8 md:mb-[40px]">
            <h3 className="text-fluid-h3 max-w-[354px]  tracking-para font-medium text-[#333333] text-center mx-auto">
          ...
          <div className="p-6 border-b border-gray-100 mt-[36px] flex flex-col items-center">
            <div className="flex items-center space-x-2 text-[#194BED]">
              ...
              <i className="fas fa-star"></i>
              <i className="fas fa-star"></i>
              <span className="text-[#333333] text-fluid-small lg:text-[16px] ml-2">Based on reviews</span>
            </div>
          </div>
          ...
          <div className="max-w-[1440px] mx-auto px-6 md:px-8 mt-[32px] grid xl:grid-cols-2 gap-6">
            ...
            <FadeUp className="bg-[#FFFFFF] font-inter xl:h-[804px] rounded-xl md:rounded-2xl p-6 md:p-8">
              <div>
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-[#000000] tracking-para text-[20px] font-medium md:text-[24px] lg:text-[30px] xl:text-[48px] leading-tight whitespace-nowrap">
                    Accqrate ONE <br />
                    The Full‑Suite ERP
                  </span>
                </div>
            ...
            <div className="space-y-6">
              <FadeUp className="bg-[#FFFFFF] font-inter xl:h-[280px] rounded-xl md:rounded-2xl p-6 md:p-8">
                <h2 className="text-[24px] font-medium">Modules included:</h2>
                <ul className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-6 gap-y-2 mt-8 text-fluid-small list-disc pl-5">
                  <li>POS</li>
                  <li>Sales</li>
                  <li>Purchase</li>
                  <li>Accounting</li>
              ...
              <FadeUp className="bg-[#FFFFFF] font-inter xl:h-[505px] rounded-xl md:rounded-2xl p-6 md:p-8">
                <h2 className="text-fluid-h3 lg:text-[24px] font-medium">What you’ll achieve:</h2>
                <ul className="text-left list-disc pl-5 space-y-1 mt-[15px] text-fluid-small">
                ...
                <h2 className="mt-8 text-fluid-h3 lg:text-[24px] font-medium">Other benefits:</h2>
                <ul className="text-left list-disc pl-5 space-y-1 mt-[15px] text-fluid-small">
        ...
        <div>
          <div className="max-w-[1440px] mx-auto px-6 md:px-8 mt-[72px] grid lg:grid-cols-2 gap-6">
            ...
            <FadeUp className="font-inter rounded-xl md:rounded-2xl flex flex-col">
              <h2 className="text-[#000000] tracking-para text-[20px] font-medium md:text-[24px] lg:text-[30px] xl:text-[48px] leading-tight whitespace-nowrap">
                Accelera <br />
                Your AI Copilot
              </h2>
              ...
              <ul className="text-left list-disc pl-5 space-y-1 mt-[15px] lg:mt-[60px] text-fluid-small">
              ...
              <button
                className="h-[40px] max-w-[399px] flex items-center justify-between px-4 text-white text-fluid-small md:text-[18px] mt-[32px] lg:mt-[60px]"
                style={{ background: 'linear-gradient(90deg, #194BED 0%, #29266E 100%)' }}
              >
      ...
      <div className="md:mx-8">
        <div className="relative md:-top-[150px] lg:-top-[200px] max-w-[1151px] pb-8 mx-auto md:border md:rounded-[40px] bg-white min-h-[400px]">
          <div>
            <h2 className="text-fluid-h2 font-medium text-center mt-8">Outcomes and The Impact</h2>
          </div>
          ...
          <div className="border-t-2 text-[#D9D9D9] mt-[40px]">
            <h2 className="text-[#000000] text-fluid-body text-center max-w-[273px] md:max-w-[677px] mx-auto mt-[28px]">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-8">
        <h2 className="text-fluid-h3 md:text-[32px] lg:text-[50px] text-left mb-8">Testimonials</h2>
      ...
      <div className="bg-[#E9E8FF] my-[50px]  ">
        ...
        <div className="solutions-carousel relative max-w-[1440px] mx-auto pl-6 md:pl-8 mt-[40px] md:mt-[38px] lg:mt-[70px]">
          <div
            ref={carouselRef}
              ...
              {CarouselCard.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex flex-col h-full justify-between">
                    <h3 className="font-medium tracking-tight text-[18px] md:text-[20px] text-black">
                      {item.title}
                    </h3>
                    <p className="text-fluid-small mt-2 md:mt-3 text-black">
                      {item.desc}
                    </p>
                  </div>
                </div>
        ...
        <div>
          <div className="px-0 md:px-8 max-w-[1440px] mx-auto py-6">
            <div className="bg-white lg:flex items-start rounded-[20px] p-6 md:p-8">
              <h2 className="text-fluid-h3 md:text-[32px] lg:text-[50px] text-left mb-8 py-[30px] md:py-[37px] tracking-heading leading-tight">Frequently Answered <br className="md:hidden" /> Questions</h2>
              <div className="mt-[56px] flex flex-col gap-8">
                {faqs.map((faq, index) => (
                  <div key={index} className="faq-item">
                    <h3 className="text-[18px] md:text-[20px] lg:text-[30px] font-medium">
                      {faq.question}
                    </h3>
                    <p className="mt-[14px] md:text-fluid-body">{faq.answer}</p>
        ...
        <div className="max-w-[1440px] mx-auto pb-6 md:pb-8 px-6">
          <div className="flex flex-col items-center">
            <h2 className="text-fluid-h3 md:text-[32px] lg:text-[50px] text-left py-[30px] md:py-[37px] tracking-heading leading-tight">Final Conversion Band</h2>
            <p className="md:text-fluid-body max-w-[315px] md:max-w-[1440px] text-center">Run compliant, AI‑powered operations with Accqrate.</p>
          </div>
